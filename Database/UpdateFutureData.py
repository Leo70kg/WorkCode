...
import IndexDailyDataStore
import IndexMinuteDataStore
...
if __name__ == '__main__':
    ...
    symbols1 = ['AG.SHF', 'AL.SHF', "AP.CZC", "AU.SHF", 'BU.SHF', 'C.DCE', 'CF.CZC',
                ...
                'ZN.SHF', 'A.DCE', 'WH.CZC', 'SC.INE', 'IH.CFE', 'IF.CFE', 'IC.CFE',
                'TS.CFE', 'TF.CFE', 'T.CFE']
    ...
    # symbols1 = ['000016.SH', '000300.SH', '000905.SH']
    # for i in [1, 5]:
    #     a = IndexMinuteDataStore.IndexMinuteData(i)
    #     a.batch_data_handle(symbols1, end_date, create_condition=True)
